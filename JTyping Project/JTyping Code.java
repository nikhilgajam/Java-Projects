...
class JTyping {
    ...
    public JTyping() {
        ...
        display.getInputMap().put(KeyStroke.getKeyStroke("shift BACK_SPACE"), "none");  // Making SHIFT+BACKSPACE to not get triggered
        display.getInputMap().put(KeyStroke.getKeyStroke("control BACK_SPACE"), "none");  // Making CTRL+BACKSPACE to not get triggered
