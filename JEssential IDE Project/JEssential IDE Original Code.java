...
class JEssential extends JFrame{
    ...
    JMenuItem new_j, open, save, save_as, quit, cut, copy, paste, select, undo, redo, count, search, replace, time, size, style, text, b_color, t_color, undo_p, redo_p, cut_p, copy_p, paste_p, save_p, build_run_p, build_btn, run_btn, build_run_btn, default_code, about;
    ...
    public JEssential(){
        ...
        replace.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, InputEvent.SHIFT_MASK));
        ...
        t_color.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, InputEvent.SHIFT_MASK));
        settings_menu.add(t_color);

        b_color = new JMenuItem("Background Color");
        b_color.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, InputEvent.SHIFT_MASK));
        ...
        build_run_btn.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, InputEvent.CTRL_MASK));
        ...
        default_code.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C, InputEvent.SHIFT_MASK));
    ...
    private void build(){
        try{
            ...
            Runtime.getRuntime().exec("cmd /c start cmd.exe /K \" javac " + path + " && exit" + "\"");
    ...
    private void run(){
        ...
        try{
            ...
            Runtime.getRuntime().exec("cmd /c start cmd.exe /K \" " + run_path.substring(0, 2) + " && cd " + run_path + " && java " + run_name.substring(0, run_name.length()-5) + "\"");
        ...
        if(saved == 1){
            ...
            if(data.equals("")){
                ...
                if(yn == JOptionPane.YES_OPTION){
                    ...
                    if(get == 1){
                        editor.setText("public class Main{\n\n  public static void main(String[] args){\n\n      System.out.println(\"Hello World\");\n\n    }\n\n}");
                        status_bar.setText(" Default Code Written ");
                    }
                }else if(yn == JOptionPane.NO_OPTION){
                    editor.setText("public class Main{\n\n  public static void main(String[] args){\n\n      System.out.println(\"Hello World\");\n\n    }\n\n}");
                    status_bar.setText(" Default Code Written ");
    ...
    private void help(){
        ...
        JOptionPane.showMessageDialog(null, "JEssential IDE Code Is Written By Nikhil", "About", JOptionPane.PLAIN_MESSAGE);
