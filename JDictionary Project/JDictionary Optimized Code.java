...
//              System.out.println(e.getKeyChar() + " " + (int)e.getKeyChar());
    ...
    private synchronized void start(){
        ...
        try{
            InputStream data_path = getClass().getResourceAsStream("dictionary.data");  // To get the data inside JAR
    ...
    class UpdateList extends Thread{
        ...
        public synchronized void run(){
            ...
            if(!inp.isEmpty()) {
                ...
                int load_count = Math.min(keywords.size(), 600);
                LinkedList<String> temp_list = new LinkedList<>();
                for(int i=0; i<load_count; i++){
                    temp_list.add(keywords.get(i));
                }
                ...
                if(count == 1){
                    count_disp_string = "\n\n" + load_count + " Word Displayed";
                }else{
                    count_disp_string = "\n\n" + load_count + " Words Displayed";

                    if(count > load_count)
                        count_disp_string += " And More...";
                }
